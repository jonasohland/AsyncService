...
/**
 * This class represents the front of a StrandExecutorDeque
 * @see StrandExecutorDeque
 */
public class StrandExecutorDequeFront extends ExecutorLayerBase {

    StrandExecutorDeque queue;

    StrandExecutorDequeFront(ExecutorLayer layer, StrandExecutorDeque q){
        super(layer);
        queue = q;
    }
