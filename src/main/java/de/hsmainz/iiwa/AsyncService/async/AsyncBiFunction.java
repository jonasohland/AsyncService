...
public class AsyncBiFunction <T, U, R> implements AsyncTask {
    ...
    public AsyncBiFunction(ExecutorLayer ctx, BiFunction<T, U, R> biFunction){
        this.biFunction = biFunction;
        exec = ctx;
    }
    ...
    public AsyncBiFunction(T in, BiFunction<T, U, R> biFunction, ExecutorLayer ctx){
        inputT = in;
        this.biFunction = biFunction;
        exec = ctx;
    }

    public AsyncBiFunction(T inT, U inU, BiFunction<T, U, R> biFunction, ExecutorLayer ctx){
        inputT = inT;
        inputU = inU;
        this.biFunction = biFunction;
        exec = ctx;
